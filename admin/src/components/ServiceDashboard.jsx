...
// Normalize the backend data that is coming from the server
        ...
        <div className={serviceDashboardStyles.container}>
          <div className={serviceDashboardStyles.innerContainer}>
            ...
            <div className={serviceDashboardStyles.header.container}>
              <div>
                <h1 className={serviceDashboardStyles.header.title}>  </h1>
              ...
              {/* Refresh */}
              <div className={serviceDashboardStyles.refreshContainer}>
                ...
                <button onClick={()=>{
                  if(Array.isArray(serviceProp)) return;
                  fetchServices({showLoading:true});
            ...
            {/* Search bar */}
             ...
             <div className={serviceDashboardStyles.table.container}>
              <div className={serviceDashboardStyles.header.medium}>
                    ...
                    <div className={serviceDashboardStyles.table.desktopview}>
                      ...
                      <div className={serviceDashboardStyles.table.desktopImage}>
                        ...
                        <div className={serviceDashboardStyles.table.desktopCenterCell(1)}>
                         ...
                         <div className={`${serviceDashboardStyles.table.desktopCell(2,)}text
                         -right`}>
                            {fromatCurrency(earning)}
...
function StatCard({icon,label,value}){
  return(
    <div className={serviceDashboardStyles.statCard.conatiner}>
      <div className={serviceDashboardStyles.statCard.iconconatiner}>
        {icon}
