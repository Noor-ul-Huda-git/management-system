...
import {pageStyles,statusClasses,keyframeStyles} from '../assets/frontend/dummyStyles'
...
//   id admin wants to cancel appointment
                        ...
                        w-full sm:w-auto">
                            ...
                            <div className={pageStyles.filterContainer}>
                                <div className={pageStyles.dateFilter}>
                                    ...
                                    <input type="date" className={pageStyles.dateInput}
                                    value={filterDate}
