     ...
     const [patientCount,setPatientCount]=useState(null);
      const [patientCountLoading,setPatientCountLoading]=useState(false);
       const [query,setQuery]=useState(" ");
        ...
        // to load doctors from ther server
         useEffect(() => {
    let mounted = true;
        ...
        <div className={s.pageContainer}>
            <div className={s.maxWidthContainer}>
                <div className={s.headerContainer}>
                    <div>
                    <h1 className={s.headerTitleContainer}>
                        DASHBOARD
                    </h1>
                ...
                <div className={s.statsGrid}>
                    ...
                    label="Total Doctors" value={totals.taotalDoctor}/>
                    
                     
                    <StatCard icon={<userRoundCheck className="w-6 h-6"/>}
                    label="Total Registered Users" value={patientCountLoading ? "Loading..."
                        :(patientCount ?? totals.totalLoginpatient)
                    }/>
                    ...
                    <StatCard icon={<BadgePakistanRupee className="w-6 h-6"/>}
