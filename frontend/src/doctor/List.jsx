...
import {listPageStyles, ListPageStyles} from '../assets/frontend/dummyStyles';
import { useParams } from 'react-router-dom';
import{Search,X,Calendar,Phone} from "lucide-react";
import{useEffect,useMemo,useState} from "react";
import { Calendar } from 'lucide-react';
const API_BASE="http://loacalost:4000"
        ...
        <div className={listPageStyles.pageContainer}>
                ...
                <div className={listPageStyles.headerContainer}>
                    <div>
                        ...
                        <p className={listPageStyles.headerSubtitle}>
                            Latest at Top- search by Patient name </p>
                    </div>
            ...
            {loading ?(
                ...
                <div className={listPageStyles.appointmentsGrid}>
                    {filtered.map((e)=>(
                        <artticle key={a.id} className={listPageStyles.appointmentCard}>
                ...
                <div className={listPageStyles.rescheduleContainer}>
                    <RescheduleButton appointment={a} onReschedule={(d,t)=>
